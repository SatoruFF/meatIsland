...
const Reviews = () => (
    <div className={cn(styles.reviewsContainer)}>
        ...
        <div className={cn(styles.reviewItem)}>
            ...
            <p className={cn(styles.reviewText)}>Отличный продукт, очень доволен!</p>
            <div className={cn(styles.reviewRating)}>Рейтинг: ⭐⭐⭐⭐⭐</div>
        </div>
        <div className={cn(styles.reviewItem)}>
            <h3 className={cn(styles.reviewName)}>Анна Смирнова</h3>
            <p className={cn(styles.reviewText)}>Хорошее качество, но доставка была медленной.</p>
            <div className={cn(styles.reviewRating)}>Рейтинг: ⭐⭐⭐⭐</div>
        </div>
        <div className={cn(styles.reviewItem)}>
            <h3 className={cn(styles.reviewName)}>Сергей Петров</h3>
            <p className={cn(styles.reviewText)}>Неплохой сервис, но есть к чему стремиться.</p>
            <div className={cn(styles.reviewRating)}>Рейтинг: ⭐⭐⭐</div>
        </div>
    </div>
);
